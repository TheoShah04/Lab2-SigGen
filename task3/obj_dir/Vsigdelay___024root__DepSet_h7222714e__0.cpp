...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    __Vdly__sigdelay__DOT__address = (0xffU & ((IData)(1U) 
                                               + (IData)(vlSelf->sigdelay__DOT__address)));
    vlSelf->sigdelay__DOT__ram2ports__DOT__ram_array[(0xffU 
                                                      & ((IData)(vlSelf->sigdelay__DOT__address) 
                                                         + (IData)(vlSelf->offset)))] 
        = vlSelf->din;
    vlSelf->dout = vlSelf->sigdelay__DOT__ram2ports__DOT__ram_array
